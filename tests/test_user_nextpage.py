...
class TestNextPageVisit:
    """ 1) check if  null visitor id's are removed
        2) duplicate (not exact, duplicate for this analysis based on same page url in the next rows)
        3) check if next page url is right
        4) count
    """
